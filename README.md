...
`npm install`
This is required to install all the required necessary packages

`npm start`
This will start the server and client application.

Server is running at `http://localhost:3000/`
Client App is running at `http://localhost:8080/`
